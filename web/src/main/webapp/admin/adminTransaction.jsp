        ...
        <form id="customerRegistrationForm">
            <div class="form-grid">
                <div class="form-group">
                    <label for="acc">Customer Account No <span>*</span></label>
                    <div class="input-with-icon">
                        <i class="fas fa-user"></i>
                        <input type="text" id="acc" placeholder="Enter Acc No" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="dcs">Description<span>*</span></label>
                    <div class="input-with-icon">
                        <i class="fas fa-envelope-square"></i>
                        <input type="text" id="dcs"  required>
                    </div>
                </div>
