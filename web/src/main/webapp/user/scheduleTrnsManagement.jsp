...
<main class="main-content">
    ...
    <div class="top-bar">
        <div class="page-title">
            ...
            <p>View and manage your automated transfers</p>
        </div>
        <a href="scheduleTransaction.jsp" style="
        background: var(--primary);
        color: white;
        padding: 10px 20px;
        border: none;
    ...
    " onmouseover="this.style.background='var(--primary-dark)'" onmouseout="this.style.background='var(--primary)'">
            <i class="fas fa-plus" style="margin-right: 8px;"></i> New Scheduled Transfer
        </a>
    </div>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Your Scheduled Transfers</h3>
        </div>
