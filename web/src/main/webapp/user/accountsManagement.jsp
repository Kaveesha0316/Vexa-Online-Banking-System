...
<main class="main-content">
    ...
    <section class="account-summary">
        ...
        <a href="accountDetails.jsp?acc=1122334455" class="account-card">
            ...
            <div class="account-details">
                <div>Interest Rate: 6.0%</div>
                <div>Status: <span class="status-maturing">Maturing</span></div>
            </div>
        </a>
    </section>

<%--    i want to view all accounts (only have 3 ) with account no ballnce ,  account type, interst rate , status , give modern way to view all accounts--%>
</main>
