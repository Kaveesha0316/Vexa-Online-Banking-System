    ...
    <div class="card">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 40px;">
            <div>
                ...
                <h4 style="font-size: 18px; font-weight: 500;">1234567890</h4>
            </div>
            <div>
                <p style="color: var(--secondary); margin-bottom: 4px;">Balance</p>
                <h4 style="font-size: 18px; font-weight: 500;">$12,500.00</h4>
            </div>
            <div>
            ...
            <div>
                ...
                <h4 style="font-size: 18px; font-weight: 500;">3.5%</h4>
            </div>
            <div>
                <p style="color: var(--secondary); margin-bottom: 4px;">Status</p>
                <h4 style="font-size: 18px; font-weight: 500; color: var(--success);">Active</h4>
            </div>
            <div>
                <p style="color: var(--secondary); margin-bottom: 4px;">Create Date</p>
                <h4 style="font-size: 18px; font-weight: 500; ">2025/02/24</h4>
            </div>
        </div>
    </div>
        ...
        <div class="transactions">
            <table>
                ...
                <tr>
                    <td>
                        <div class="transaction-detail">
                            <div class="transaction-icon icon-income"><i class="fas fa-arrow-down"></i></div>
                    ...
                    <td>2025-07-05</td>
                    <td class="transaction-amount positive">+ $3,000.00</td>
                    <td><span class="transaction-status status-completed">Completed</span></td>
                </tr>
                <tr>
                    <td>
                        <div class="transaction-detail">
                            <div class="transaction-icon icon-expense"><i class="fas fa-shopping-cart"></i></div>
                            <div class="transaction-info">
                ...
                <tr>
                    <td>
                        <div class="transaction-detail">
                            <div class="transaction-icon icon-transfer"><i class="fas fa-exchange-alt"></i></div>
                            <div class="transaction-info">
